 ...
 * @since 1.1.0
 */
public class BootstrapMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = BootstrapMetadata.class.getName();
    ...
    public BootstrapMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
